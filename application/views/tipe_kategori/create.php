    ...
    <section class="content-header">
        <h1>
            ...
            <small>Create Tipe Kategori</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('dashboard')?>"><i class="fa fa-home"></i> Home</a></li>
            <li class="active"><a href="<?php echo base_url('tipe_kategori')?>">Tipe Kategori</a></li>
            <li class="active"><a href="<?php echo base_url('tipe_kategori/create')?>">Create Tipe Kategori</a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <div class="cleaner_h3"></div>
                        <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url('tipe_kategori/create') ?>">
