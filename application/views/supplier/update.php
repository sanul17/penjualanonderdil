    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control flat" id="nama_supplier" name="nama_supplier" value='<?php echo $nama_supplier; ?>'>
                        </div>
                ...
                <div class="col-md-2">
                    <input type="text" class="form-control flat" id="kota" name="kota" value='<?php echo $kota; ?>'>
                </div>
            ...
            <div class="col-md-2">
                <input type="text" class="form-control flat" id="telepon" name="telepon" value='<?php echo $telepon; ?>'>
            </div>
