                        ...
                        <table id="dataTable" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                foreach ($data as $key => $value) {
                                    ?>
                                    <tr>
                                        <td><?php echo $value->kd_supplier; ?></td>
                                        ...
                                        <td style="text-align:center;">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="<?php echo base_url('supplier/update/'.$value->kd_supplier);?>">Update</a>
                                                    </li>
                                                    <li>
                                                        <a href="<?php echo base_url('supplier/detail/'.$value->kd_supplier);?>">Detail</a>
                                                    </li>
                                                    <li>
                                                        <a href="#deleteModal" role="button" data-toggle="modal" onclick="deleteModalFunction('<?php echo $value->kd_supplier; ?>')">Delete</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
