                        ...
                        if ($this->session->userdata('level') == 'owner' || $this->session->userdata('level') == 'admin') {
                            ...
                            <li>
                                <a href="<?php echo base_url('barang')?>">
                                    <i class="fa fa-th"></i> <span>Barang</span> <small class="badge pull-right bg-red">3</small>
                                </a>
                            </li>
                            <li class="treeview">
                                <a href="#">
                                ...
                                <ul class="treeview-menu">
                                    <li><a href="<?php echo base_url('orderan')?>"><i class="fa fa-angle-double-right"></i> Orderan  <small class="badge pull-right bg-red">3</small></a></li>
                            ...
                            <li>
                                <a href="<?php echo base_url('barang')?>">
                                    <i class="fa fa-th"></i> <span>Barang</span> <small class="badge pull-right bg-red">new</small>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url('orderan')?>">
                                    <i class="fa fa-th"></i> <span> Orderan</span>
                                </a>
                            </li>
                            <?php
                        }
