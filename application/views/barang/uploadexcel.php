            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <div class="cleaner_h3"></div>
                        <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url('barang/uploadexcel') ?>">
                            <input type="text" class="flat" name="coba">
