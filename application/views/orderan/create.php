            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url('orderan/create') ?>">
                            ...
                            foreach ($this->cart->contents() as $items) {
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td style="text-align:center;">
                                        <a href="#" class="btn btn-default flat delbutton" id="<?php echo 'create/'.$items['rowid'].'/'.$kd_order.'/'.$items['id'].'/'.$items['qty']; ?>"><i class="fa fa-trash fa-fw"></i> Delete</a>
                                    </td>
                                </tr>
                                <?php
                                $i++; $no++;
