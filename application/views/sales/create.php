    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="<?php echo base_url('sales/create')?>">Create Sales</a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <div class="cleaner_h3"></div>
                        <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data" action="<?php echo base_url('sales/create') ?>">
                            ...
                            ?>
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control flat" id="nama_sales" name="nama_sales" value='<?php echo set_value('nama_sales'); ?>'>
                                </div>
