...
class MyCart {
	 ...
	 */
	public function __construct($params = array(), $cart_sess_name = 'cart_contents')
	{
		...
		if ($this->CI->session->userdata($this->cart_sess_name) !== FALSE)
		{
			$this->_cart_contents = $this->CI->session->userdata($this->cart_sess_name);
		}
		else
		{
	...
	function _save_cart()
	{
		...
		{
			$this->CI->session->unset_userdata($this->cart_sess_name);
		...
		$this->CI->session->set_userdata(array($this->cart_sess_name => $this->_cart_contents));
